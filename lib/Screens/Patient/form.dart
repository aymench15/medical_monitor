...
class Informations extends StatefulWidget {
  ...
  @override
  State<Informations> createState() => _AppointmentState();
}

class _AppointmentState extends State<Informations> {
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextFormField(
                        controller: _reasonController,
                        decoration: InputDecoration(
                          labelText: 'Intensity of exercice',
                          prefixIcon: Icon(Icons.description),
                        ),
                      ),
                      SizedBox(height: 10),
